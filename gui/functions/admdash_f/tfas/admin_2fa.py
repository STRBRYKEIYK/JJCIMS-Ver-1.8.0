...
class Admin2FA:
    ...
    def fade_out(self, callback):
        ...
        try:
            ...
            if alpha > 0:
                ...
                self.overlay.after(1, callback)  # Schedule callback for next event loop iteration
        except Exception:
    ...
    def setup_ui(self):
        # Title label
        title = tk.Label(self.frame, text='2FA Verification Required', font=('Segoe UI', 28, 'bold'), bg='#000000', fg='#800000')
        title.pack(pady=30)
        # Info label
        info = tk.Label(self.frame, text='Enter your 2FA code:', font=('Segoe UI', 14), bg='#000000', fg='#fffde7')
        info.pack(pady=10)
        ...
        entry_width = 3
        for i in range(6):
            entry = tk.Entry(entry_frame, font=('Segoe UI', 24), bg='#23272b', fg='#fffde7', insertbackground='#fffde7', width=entry_width, relief='solid', justify='center')
        ...
        # Status label
        self.status_label = tk.Label(self.frame, text='', font=('Segoe UI', 12), bg='#000000', fg='#b71c1c')
        self.status_label.pack(pady=5)

        # Buttons
        btn_frame = tk.Frame(self.frame, bg='#000000')
        btn_frame.pack(pady=40)
        verify_btn = tk.Button(btn_frame, text='Verify', font=('Segoe UI', 16, 'bold'), bg='#800000', fg='#fffde7', width=16, height=2, command=self.verify_2fa)
        verify_btn.pack(side='left', padx=15)
        cancel_btn = tk.Button(btn_frame, text='Cancel', font=('Segoe UI', 16, 'bold'), bg='#232b2b', fg='#fffde7', width=16, height=2, command=self.close_windows)
