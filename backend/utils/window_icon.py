...
def set_window_icon(window):
    ...
    """
    try:
        # Get the path to the icon files - go up two levels from backend/utils to root
        current_dir = os.path.dirname(
            os.path.abspath(__file__)
        )  # backend/utils directory
        app_root = os.path.dirname(
            os.path.dirname(current_dir)
        )  # root directory (up two levels)
        ...
        ico_path_fallback = os.path.join(app_root, "frontend", "icons", "JJCFPIS.ico")
        ...
        png_path = os.path.join(app_root, "frontend", "assets", "JJCIMS.png")
        if not os.path.exists(png_path):
            # Try other PNG locations as fallback
            png_path = os.path.join(app_root, "frontend", "assets", "JJCFPIS.png")
